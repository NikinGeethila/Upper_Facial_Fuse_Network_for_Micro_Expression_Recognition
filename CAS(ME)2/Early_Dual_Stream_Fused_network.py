...
def evaluate(SegmentOne_train_images,SegmentTwo_train_images, SegmentOne_validation_images,SegmentTwo_validation_images,SegmentOne_train_labels,SegmentOne_validation_labels ,test_index ):
    ...
    filepath="weights_CAS(ME)2/Early-weights-improvement"+str(test_index)+"-{epoch:02d}-{val_acc:.2f}.hdf5"
...
results.write(str(os.path.dirname(full_path))+" {0}_{1}_{2}_{3}x{4}x{5}\n".format(testtype,SegmentNameOne,SegmentNameTwo,sizeH, sizeV,sizeD))
results.write("---------------------------\n")
