...
def evaluate(SegmentOne_train_images,SegmentTwo_train_images, SegmentOne_validation_images,SegmentTwo_validation_images,SegmentOne_train_labels,SegmentOne_validation_labels ,test_index ):
    ...
    dense_1 = Dense(6, init='normal' )(flatten_1)
    ...
    filepath="weights_CASMEII/Early-weights-improvement"+str(test_index)+"-{epoch:02d}-{val_acc:.2f}.hdf5"
...
def kfold():
    ...
    val_labels = []
    pred_labels = []
    for train_index, test_index in kf.split(testerOne_set):
