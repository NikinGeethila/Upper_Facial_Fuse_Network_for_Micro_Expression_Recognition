...
for typepath in (paths):
    ...
    for video in directorylisting:
        ...
        for frame in framerange:
            ...
            up = max(numpylandmarks[50][1], numpylandmarks[51][1], numpylandmarks[52][1]) - 5
            down = max(numpylandmarks[55][1], numpylandmarks[56][1], numpylandmarks[57][1], numpylandmarks[58][1],
                       numpylandmarks[59][1]) + 5
            left = numpylandmarks[49][0] - 10
            right = numpylandmarks[54][0] + 10
...
------------------------------------
up = max(numpylandmarks[50][1], numpylandmarks[51][1], numpylandmarks[52][1]) - 5
down = max(numpylandmarks[55][1], numpylandmarks[56][1], numpylandmarks[57][1], numpylandmarks[58][1], numpylandmarks[59][1]) + 5
left = numpylandmarks[49][0]-10
right = numpylandmarks[54][0] +10
"""